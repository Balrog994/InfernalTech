...
public class WorldGenMinableCustom extends WorldGenerator
{
    ...
    public WorldGenMinableCustom(IBlockState p_i45630_1_, int p_i45630_2_)
    {
        this(p_i45630_1_, p_i45630_2_, BlockHelper.forBlock(Blocks.stone));
    }

    public WorldGenMinableCustom(IBlockState p_i45631_1_, int p_i45631_2_, Predicate p_i45631_3_)
    {
